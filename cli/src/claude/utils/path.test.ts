...
describe('getProjectPath', () => {
    const expectedProjectId = (workingDir: string) => resolve(workingDir).replace(/[^a-zA-Z0-9]/g, '-');
    ...
    it('should replace slashes with hyphens in the project path', () => {
        ...
        expect(result).toBe(join('/home/user', '.claude', 'projects', expectedProjectId(workingDir)));
    });
