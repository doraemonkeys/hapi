import type { SlashCommand, SlashCommandSource, SlashCommandsResponse } from '@hapi/protocol/types';
...
type SlashCommandScanSource = Exclude<SlashCommandSource, 'builtin'>;

export type { SlashCommand } from '@hapi/protocol/types';
 ...
 * built-in -> global user -> plugin -> project.
 */
